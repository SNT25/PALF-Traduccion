    ...
    class CustomCharacter():
        ...
        def __call__(self, what, **kwargs):
            ...
            if (what == ""):
                ...
                # To apply the BipBop to ALL characters not named "", uncomment the following:
                # formatcallback=functools.partial(boopy_voice, boopfile="Audio/pmd_speak.ogg")
...
define defaultpersondex = {
    ...
    "Falkner" : {"Named" : False, "Value" : 0, "Contact": False, "Sex": Genders.Male, "Relationship": "Underclassman", "RelationshipRank": 0, "Events": [], "Mood": 0, "Nature": TrainerNature.Special},
    ...
    "Kate" : {"Named" : False, "Value" : 0, "Contact" : False, "Sex": Genders.Female, "Relationship": "Citizen", "RelationshipRank": 0, "Events": [], "Mood": 0, "Nature": TrainerNature.Special },
    "Summer" : {"Named" : False, "Value" : 0, "Contact" : False, "Sex": Genders.Female, "Relationship": "Citizen", "RelationshipRank": 0, "Events": [], "Mood": 0, "Nature": TrainerNature.Special },
    "Shauna" : {"Named" : False, "Value" : 0, "Contact" : False, "Sex": Genders.Female, "Relationship": "Classmate", "RelationshipRank": 0, "Events": [], "Mood": 0, "Nature": TrainerNature.Special }
}
...
define dungeonnarrator = Character(None, window_background="gui/dungeontextbox.png", window_align=(0.0, 1.0), what_pos=(120, 40), what_xmaximum=1530, what_font="fonts/pmdfont.ttf", what_size=55, show_layer="master", callback=boopy_voice_dungeonnarrator)
...
define charlist = [oak, pikachu, starter, red, mom, blue, silver, brawly, roxanne, 
    ...
    lace, oldman, anabel, allister, phobos, kate, summer]
...
define sceneconditions = {
    ...
    "Misty2" : {"Level" : 4, "NotEvent" : ["Misty", "Scene2Part1", "Text Misty at night."]},
