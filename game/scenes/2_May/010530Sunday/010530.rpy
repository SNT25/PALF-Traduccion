...
yellow @sadbrow talking2mouth "Um."
...
yellow @talkingmouth "Do you have one in mind?"
...
yellow @sadbrow talkingmouth "Oh, Leaf, no..."
...
melody @talkingmouth "You done with your dorky evil conference call?"
...
melody @talkingmouth "It's not like I don't know about it. Evil plan, yadda yadda, secret council, codenames and stuff. You know I don't care about any of that."
...
melody @sadbrow talkingmouth "The more I hear about this plan, the lamer it sounds."

phobos @angrysharkmouth "Leave me! I have more... more planning to do!"

melody @talkingmouth "Hold on. I've got another favor to ask."
...
melody @talkingmouth "You didn't do that part for me. I know how important I am to your 'schemes.'"
melody @closedbrow talkingmouth "And as long as I know that... I know that you'll be a good 'uncle' and give me another favor."

phobos @angrybrow angrysharkmouth "You... you... you...!"

melody @talkingmouth "The Battle Team is way more powerful this year than last year. Most students are. I want to know why."
...
melody @talkingmouth "No, it's never that. {i}Something{/i} or someone caused it. Find out what."

pause 1.0

phobos @angrybrow angrysharkmouth "I don't see how this relates to your plan at all."

melody @talkingmouth "Planning? No, that's your thing. That's what that useless Drayden does. That's what that pervert Wallace does."

melody @talkingmouth "I don't plan."
...
if (HasItem(Item.CelebiWing)):
    $ calDate = calDate.replace(day=16, month=5, year=2004)
    
    narrator "What...? The {color=#0f0}Celebi Wing{/color} in your inventory is starting to shine...!"

    pause 1.0

    narrator "(No, there's no lore reason for this, just go with it. It's a Mystery Gift.)"

    narrator "Thanks for being patient."

    $ LoseItem(Item.CelebiWing)
