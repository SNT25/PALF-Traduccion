...
oak @talkingmouth "His efforts paid off November 11th of the same year. He won his thirty-fourth attempt at the Kanto league, and became the Kanto champion."
...
melody @talkingmouth "Karen and Will. This is easily-accessible information."
...
janine @closedbrow talkingmouth "Naturally, we will encounter no problems."
...
melody -sadbrow -bubblemouth @talkingmouth "Yeah, that's fair. I'd pick him, too."
melody @talkingmouth "Alright. We tried. No luck. Let's bounce."
...
melody @talkingmouth "{size=30}Ow.{/size}"
...
melody @talkingmouth "I... look. She said no. We don't need this. Let's just go."
...
menu:
    ">Volunteer to battle":
        ...
        janine @talkingmouth "Jeez, [first_name]... so reckless. Always getting in fights."

        show melody surprisedbrow with dis

        janine -closedbrow @talkingmouth "Sorry about this guy. I can't control him. If he wants to battle, he will."
        janine @closedbrow talkingmouth "Personally, I'd be against it, of course..."
    ...
    ">Stay silent":
        janine @confusedbrow talkingmouth "...Ugh. Fine. I'll make someone battle Melody."
...
melody @talkingmouth "...You. [melody_name], right?"

if (melody_name != first_name):
    red @talking2mouth "You know it's not."

melody @talkingmouth "...I should let you know, I don't make a good first impression in battle."
melody @talking2mouth "Of course, I don't make a good first impression, period."
melody @angrybrow talkingmouth "And the really sad part is..."
...
if (not WonBattle("Melody1")):
    ...
    melody @talkingmouth "{size=30}What...?{/size}"
...
if (highestlevel > 16):
    melody @talkingmouth "Talking. You, [melody_name]. What the eff? You have a level [highestlevel] Pokémon?"
    ...
    melody -surprisedbrow -frownmouth -surprised @talkingmouth "No, it's totally normal, except that it's {i}May{/i}."

    red @confused "I don't get it. I mean, I'm a member of the Battle Team. That's pretty normal, right?"

    melody @talkingmouth "Yeah, except that at this time last year, even the Battle Team members had, like, level {i}thirteens{/i}."
    ...
    melody @talkingmouth "Janny, what are you feeding these kids?!"

    janine -closedbrow @angrybrow talking2mouth "Get out of my Battle Hall."

    melody @surprisedbrow talkingmouth "No, I'm serious. Can anyone tell me? This is just the Battle Team, right? There isn't anyone else who's got these crazy levels, do they?"
    ...
    melody @talkingmouth "Sucks to be me, then."
...
janine @talkingmouth "Thank you."
janine @talkingmouth "Oh, yeah. Good job kicking Melody's ass."

$ ValueChange("Janine", 5)

janine @sadbrow talkingmouth "Don't want to imagine what the team would be like with her on it..."

red @confused "Why, what happened last year?"

janine @closedbrow talkingmouth "She broke the team apart. And she wasn't even on it."

pause 0.5

janine @talking2mouth "That's all you need to know."
janine @closedbrow talkingmouth "Now get in line. We're doing some horn drills."
...
janine @talkingmouth "If you survive, it means you're a higher level."
