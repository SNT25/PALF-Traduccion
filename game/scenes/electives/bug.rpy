...
if (not HasEvent("Instructor Burgh", 1)): #first class
    ...
    burgh "[timeOfDay], estudiantes."

    if (not IsDate(5, 4, 2004)):
        burgh "Oh? I see we have some new faces in class today."

    burgh "Bienvenidos a sus {color=#0048ff}clases de tipo Bicho{/color} de este semestre.{w=0.5} Como quizás hayan adivinado, seré su instructor. Me llamo Burgh."
    
    $ BecomeNamed("Instructor Burgh")
    burgh happy2 "Please do just call me Burgh. None of this 'Mr. Burgh' or 'Instructor Burgh' nonsense."
    burgh norm2 "I'd rather you think of me as your friend than as your boss.{w=0.5} It {i}is{/i} my job to care about my students, afterall."
    ...
    burgh norm2 "We'll be studying the anatomy and evolution of Bug Pokémon for the first part of the semester, and then we'll move on to rendering live models."
    burgh happy "If we're lucky, perhaps we can take a field trip to attend one of Johto's Bug-catching contests!"

    ethan uniform "Seriously?! That'd be so rad! I loved those!"
